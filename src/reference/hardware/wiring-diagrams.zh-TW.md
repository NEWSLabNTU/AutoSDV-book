...
- Source file: wiring-diagrams.md
...
*注意：相機透過 ZED Link 的 GMSL2 連接接收電源。ZED Link 透過 SAMTEC CSI 埠連接至 Jetson AGX Orin 底部。*
...
*注意：每個電池都有自己的獨立監控器與內建警報。*

## GPIO 40 針接頭參考

詳細的接腳規格可在 [JetsonHacks](https://jetsonhacks.com/nvidia-jetson-agx-orin-gpio-header-pinout/) 上找到。

**實體配置注意事項：** 從上方查看 Jetson 時，Pin 1-2 實際位於接頭的最右側。Pin 39-40 位於最左側。

| 裝置     | 標籤                                    | Pin No. (上排) | Pin No. (下排) | 標籤                                    | 裝置     |
|---------|-----------------------------------------|----------------|----------------|-----------------------------------------|----------|
...
- [硬體組裝指南](../../getting-started/hardware-assembly.md) - 實體組裝
- [軟體安裝](../../getting-started/installation/overview.md) - 軟體設定
- [核心組件](../hardware/core-components.md) - 組件規格
